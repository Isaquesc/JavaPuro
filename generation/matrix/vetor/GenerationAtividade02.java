...
public class GenerationAtividade02 {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "A soma dos numeros impares é: " + QuantidadeImpares + "\n");
		JOptionPane.showMessageDialog(null, "A soma dos numeros pares é: " + QuantidadePar + "\n");
		
		//System.out.printf("A soma dos numero impares é: %d", QuantidadeImpares);8
		//System.out.printf("\nA soma dos numero pares é: %d", somaPar);
